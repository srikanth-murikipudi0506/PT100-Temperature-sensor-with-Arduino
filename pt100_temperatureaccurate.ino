...
//	Serial.print(", ohms: ") ; Serial.println(ohms,2) ;
  ...
  // compare lookup table and common computational methods
	...
	Serial.print("Tlut   = ") ; Serial.print(Tlut  ,1) ; Serial.println(" C (exact)") ;
//	Serial.print("Tcvd   = ") ; Serial.print(Tcvd  ,1) ; Serial.println(" C") ;
//	Serial.print("Tcube  = ") ; Serial.print(Tcube ,1) ; Serial.println(" C") ;
//	Serial.print("Tpoly  = ") ; Serial.print(Tpoly ,1) ; Serial.println(" C") ;
 //	Serial.print("Trpoly = ") ; Serial.print(Trpoly,1) ; Serial.println(" C") ;
  	Serial.println();
  // float temp = (Tlut-0.5);
 // Serial.println("Temp:"+String(temp));
  ...
  //u8g2.print("Temp: "+String(temp));
  u8g2.print("Temp: "+String(Tlut  ,1));
  u8g2.sendBuffer();
	checkFault() ;
  /*
    if(Tlut>33){  
